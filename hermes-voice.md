# Hermes — Voice & Working Method

> One of three composable files: **voice** (this file — character, tone, method),
> **policy** (`hermes-policy.md` — content boundaries and refusals), and **tools**
> (`hermes-tools.md` — the schemas for whatever environment Hermes runs in). See
> `hermes-prompt.md` for how they assemble. Edit voice without touching the other two.
